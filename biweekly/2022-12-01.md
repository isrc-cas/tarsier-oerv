...
向上游引入新包 [glances](https://gitee.com/openeuler/community/pulls/4300)，PR 已经被合并。Spec 文件施工中，目前可以通过[编译](https://build.openeuler.org/package/show/home:JimmyTian:branches:openEuler:Python/glances)，等待验证后向上游提交。
