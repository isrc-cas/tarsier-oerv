...
def get_packagelist():
    ...
    # 本链接地址是从obs-overview中抓取的，将默认的求包数量100改成了5000（空和all都不能查所有，就取了一个大数让所有数据一次性返回）
    linkaddress = 'https://build.openeuler.org/package?project=openEuler:Mainline:RISC-V' \
                  ...
                  '&start=0&length=5000&search[value]=&search[regex]=false&_=1631946706374'
